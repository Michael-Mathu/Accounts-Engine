...
export const RefreshCwIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ className, size = 24, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
export const TruckIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ className, size = 24, ...props }, ref) => (
    ...
    >
      ...
      <path d="M15 18H9" />
      <path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62L18.3 9.38a1 1 0 0 0-1-.38H14" />
...
export const BanknoteIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ className, size = 24, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
export const ReceiptIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ className, size = 24, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
export const Building2Icon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ className, size = 24, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
      ...
      {...props}
    >
      <path d="M22 21v-2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v2" />
      <path d="M14 9V4a2 2 0 0 0-2-2h-1a2 2 0 0 0-2 2v5" />
...
export const ListTreeIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ className, size = 24, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
      ...
      {...props}
    >
      <path d="M21 12h-4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h4" />
      <path d="M21 2h-7" />
      <path d="M14 20a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h4" />
      <path d="M3 10h18" />
      <path d="M3 18h18" />
    </svg>
  )
